...
uvx --from keymap-drawer keymap -c ./keymap-drawer.config.yaml draw ./keymap-drawings/kyria.yaml > ./keymap-drawings/kyria.svg
...
uvx --from keymap-drawer keymap -c ./keymap-drawer.config.yaml draw ./keymap-drawings/silakka.yaml > ./keymap-drawings/silakka.svg
