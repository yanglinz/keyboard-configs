...
./bin/qmk-cli.sh c2json keyboards/splitkb/halcyon/kyria/keymaps/default/keymap.c > ./keymap-drawings/kyria.json
jq '.keyboard = "splitkb/halcyon/kyria/rev4"' ./keymap-drawings/kyria.json > ./keymap-drawings/kyria.json.tmp && mv ./keymap-drawings/kyria.json.tmp ./keymap-drawings/kyria.json
